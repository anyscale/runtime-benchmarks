...
class ObjectDetectionModel:    
    ...
    def _load_imagenet_labels(self) -> List[str]:
        return [
            ...
            "Maltese dog", "Pekinese", "Shih-Tzu", "Blenheim spaniel",
            ...
            "Irish setter", "Gordon setter", "Brittany spaniel", "clumber",
            ...
            "Siamese cat", "Egyptian cat", "lion", "tiger", "jaguar",
            "leopard", "snow leopard", "lynx", "leopard cat", "cougar",
            "bobcat", "cheetah", "brown bear", "American black bear",
            ...
            "patas", "baboon", "macaque", "langur", "colobus", "proboscis monkey",
            ...
            "bulletproof vest", "bullet train", "butcher shop", "cab", "cafe",
            "caldron", "camera", "cannon", "canoe", "can opener", "cardigan",
            ...
            "china cabinet", "Christmas stocking", "church", "cinema",
            ...
            "cornet", "cowboy boot", "cowboy hat", "cradle", "crane",
            "crash helmet", "crate", "crib", "Crock Pot", "croquet ball",
            "crutch", "cuirass", "dam", "desk", "desktop computer",
            "dial telephone", "diaper", "digital clock", "digital watch",
            "dining table", "dishrag", "dishwasher", "disk brake", "dock",
            "dogsled", "dome", "doormat", "drilling platform", "drum",
            ...
            "goblet", "go-kart", "golf ball", "golfcart", "gondola",
            "gong", "gown", "grand piano", "greenhouse", "grille",
            ...
            "hoopskirt", "horizontal bar", "horse cart", "hourglass",
            "iPod", "iron", "jack-o'-lantern", "jean", "jeep", "jersey",
            ...
            "limousine", "liner", "lipstick", "Loafer", "lotion", "loudspeaker",
            "loupe", "lumbermill", "magnetic compass", "mailbag", "mailbox",
            ...
            "mouse", "mousetrap", "moving van", "muzzle", "nail",
            "neck brace", "necklace", "nipple", "notebook", "obelisk",
            "oboe", "ocarina", "odometer", "oil filter", "organ",
            "oscilloscope", "overskirt", "oxcart", "oxygen mask", "packet",
            "paddle", "paddlewheel", "padlock", "paintbrush", "pajama",
            "palace", "panpipe", "paper towel", "parachute", "parallel bars",
            "park bench", "parking meter", "passenger car", "patio", "pay-phone",
            "pedestal", "pencil box", "pencil sharpener", "perfume", "Petri dish",
            "photocopier", "pick", "pickelhaube", "picket fence", "pickup",
            "pier", "piggy bank", "pill bottle", "pillow", "ping-pong ball",
            ...
            "prison", "projectile", "projector", "puck", "punching bag",
            "purse", "quill", "quilt", "racer", "racket", "radiator",
            "radio", "radio telescope", "rain barrel", "ramjet", "rapier",
            "raspberry", "ratchet", "ray gun", "razor", "razorblade",
            "reel", "reflex camera", "refrigerator", "remote control", "restaurant",
            "revolver", "rifle", "rocking chair", "rotisserie", "rubber eraser",
            "rugby ball", "rule", "running shoe", "safe", "safety pin",
            ...
            "wok", "wooden spoon", "wool", "worm fence", "wreck", "yawl",
            ...
            "burrito", "red wine", "espresso", "cup", "eggnog", "alp",
            ...
            "corn", "acorn", "hip", "buckeye", "coral fungus", "agaric",
